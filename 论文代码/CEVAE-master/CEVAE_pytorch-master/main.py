...
dataset = DATA(replications=args.reps)
...
for i, (train, valid, test, contfeats, binfeats) in enumerate(dataset.get_train_valid_test()):
    ...
    p_x_z_dist = p_x_z(dim_in=args.z_dim, nh=3, dim_h=args.h_dim, 
    ...
    for epoch in range(n_epoch):
        ...
        for j in range(n_iter_per_epoch):
            ...
            z_infer = q_z_tyx_dist(xy=xy, t=t_train) # 先用训练集训练出一个初始的推断z的网络
            # use a single sample to approximate expectation in lowerbound
            z_infer_sample = z_infer.sample() # 对这个网络进行采样
            ...
            loss_mean = torch.mean(  l2 / 10000000 + l3 + l4 /100000000+ l5/100000 + l6/100000 + l7 /10000000)
